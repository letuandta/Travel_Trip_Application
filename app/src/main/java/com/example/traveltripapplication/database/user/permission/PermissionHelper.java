package com.example.traveltripapplication.database.user.permission;

import static com.example.traveltripapplication.database.user.permission.PermissionContract.PermissionEntry;
