package com.example.traveltripapplication.database.user.position;
...
import com.example.traveltripapplication.database.user.position.PositionContract.PositionEntry;
