package com.example.traveltripapplication.database.user.user;

import static com.example.traveltripapplication.database.user.user.UserContract.*;
...
import com.example.traveltripapplication.database.user.contacts.ContactsContract;
import com.example.traveltripapplication.database.user.state.StateContract;
