package com.example.traveltripapplication.data.database.user.user;

import static com.example.traveltripapplication.data.database.user.user.UserContract.*;
...
import com.example.traveltripapplication.data.database.user.contacts.ContactsContract;
import com.example.traveltripapplication.data.database.DatabaseInformation;
import com.example.traveltripapplication.data.database.user.state.StateContract;
